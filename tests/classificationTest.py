...
#    for x in []:
  ...
  def testTwoStepClassifier(self):  # - - - - - - - - - - - - - - - - - - - - -
    ...
    # Loop over various paramter values
    #
    for (s1mm, s1nmm) in [((1.0,'threshold',0.1),    (0.0,'threshold',0.1)),
      ...
      for (rs, s2c) in [(None, ('svm', 'LINEAR', 5)),
                        (None, ('kmeans', mymath.distCanberra)),
                        (('uniform',10,10), ('svm', 'LINEAR', 10)),
                        (('uniform',10,10), ('kmeans', mymath.distL1)),
                        (('uniform',5,20), ('svm', 'POLY', 0.1)),
                        (('uniform',5,20), ('kmeans', mymath.distL2)),
                        (('uniform',20,5), ('svm', 'RBF', 0.5)),
                        (('uniform',20,5), ('kmeans', mymath.distLInf)),
                        (('linear',10,10), ('svm', 'SIGMOID',1)),
                        (('linear',10,10), ('kmeans', mymath.distCanberra)),
                        (('linear',10,50), ('svm', 'LINEAR', 0.01)),
                        (('linear',10,50), ('kmeans', mymath.distL1)),
                        (('linear',50,30), ('svm', 'POLY', 12)),
                        (('linear',40,40), ('kmeans', mymath.distCanberra)),
                        (('exponential',10,10), ('svm', 'RBF', 99)),
                        (('exponential',10,10), ('kmeans', mymath.distLInf)),
                        (('exponential',10,50), ('svm', 'SIGMOID', 0.97)),
                        (('exponential',10,50), ('kmeans',mymath.distL1)),
                        (('exponential',30,50), ('svm', 'LINEAR',1.0)),
                        (('exponential',40,40), ('kmeans',mymath.distL2))]:
#        pass
#      for x in []:
