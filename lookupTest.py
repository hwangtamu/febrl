...
class TestCase(unittest.TestCase):
  ...
  #
  def setUp(self):
    self.tag_lookup_files = ['data'+os.sep+'post_address.tbl',
                             'data'+os.sep+'postcode_nsw.tbl',
                             'data'+os.sep+'address_misc.tbl',
                             'data'+os.sep+'saints.tbl',
                             'data'+os.sep+'givenname_f.tbl',
                             'data'+os.sep+'surname.tbl']

    self.frequency_lookup_files = ['data'+os.sep+'givenname_f_freq.csv',
                                   'data'+os.sep+'surname_nsw_freq.csv',
                                   'data'+os.sep+'postcode_act_freq.csv']

    self.geocode_lookup_files = ['data'+os.sep+'postcode_centroids.csv']

    self.correction_list_files = ['data'+os.sep+'address_corr.lst',
                                  'data'+os.sep+'name_corr.lst']
