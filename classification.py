...
#          vec_sum += abs(w-nm_val)          # Manhatten distance
    ...
    #
      ...
      print '    Number of weight vectors:', len(w_vec_dict)
      print '    Number of unclassifieds: ', len(nn_to_classify_w_vec_dict)
      print '    Number of matches:       ', len(nn_m_train_w_vec_dict)
      print '    Number of non-matches:   ', len(nn_nm_train_w_vec_dict)
